classdef TransformerDiagnosticApp1 < matlab.apps.AppBase
    ...
    properties (Access = private)
      ...
      %  PlotLimits struct                   % Stores plot axis limits
       ...
       % Clould intigration 
        ...
        ThingSpeakChannelID      double = 3010751  % Store as numeric
        ThingSpeakWriteAPIKey    char = 'Y90BTBOQ908PATXC'
        ThingSpeakReadAPIKey     char = 'S3DZJ3FY18YN3P40'    
        %ThingSpeakTimer          timer 
        ThingSpeakTimer          timer = timer.empty
        %ThingSpeakTimer          matlab.ui.control.Timer
        SecondThingSpeakChannelID double = 3011875       % Secondary channel ID (initialize to 0)
        SecondThingSpeakReadAPIKey char = 'QP6QNAN37ZYRTUZ8' 
    ...
    try
        ...
        line(headerAx, [0 1], [0.1 0.1], 'Color', [0 0.35 0.74], 'LineWidth', 2);
        ...
        text(sectionAx, 0, 0.5, '2. FAULT ANALYSIS', ...
             'FontSize', 14, 'FontWeight', 'bold', 'VerticalAlignment', 'top');
